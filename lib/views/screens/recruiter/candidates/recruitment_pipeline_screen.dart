...
class _RecruitmentPipelineScreenState extends State<RecruitmentPipelineScreen>
  ...
  Widget _buildCandidateCard(
      Map<String, dynamic> c, bool isDark, String stage) {
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                ...
                child: Text((c['candidate_name']?[0] ?? 'C').toUpperCase(),
                    style: TextStyle(
                        fontSize: 18,
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(c['candidate_name'] ?? 'Candidate',
                        style: GoogleFonts.inter(
                            fontSize: 15, fontWeight: FontWeight.w700)),
                    Text(c['job_title'] ?? 'Role',
                        style: GoogleFonts.inter(
                            fontSize: 12,
                            color: Colors.grey,
          ...
          Row(
            children: [
              _buildMetaItem(
                  Icons.work_history_rounded, c['experience'] ?? 'N/A'),
              const SizedBox(width: 12),
            ...
            children: [
              Expanded(
                  child: _buildQuickAction(
                      'Resume', Icons.description_outlined, isDark, () {})),
              const SizedBox(width: 8),
              Expanded(
                  child: _buildQuickAction('Move Stage', Icons.input_rounded,
                      isDark, () => _showStagePicker(c))),
              const SizedBox(width: 8),
            ...
            child: Column(
              ...
              children: [
                ...
                ..._stages.map((stage) => ListTile(
                      title: Text(stage),
                      trailing: _normalizeStage(app['status']?.toString() ?? '') ==
                              _normalizeStage(stage)
