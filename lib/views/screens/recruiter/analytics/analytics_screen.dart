...
class _AnalyticsScreenState extends State<AnalyticsScreen>
        ...
        return ListView(
          ...
          children: [
            ...
            _buildChartCard(
              context,
              isDark,
              _VelocityLineChart(trends: trends),
            ),
            SizedBox(height: Responsive.spacing(24)),
  ...
  Widget _buildFunnelAnalysis(bool isDark, Map<String, dynamic> pipeline) {
    final stages = [
      {
        'l': 'Applied',
        'v': pipeline['Applied']?.toString() ?? '0',
        'p': 1.0,
        'c': Colors.blue,
      },
      {
        'l': 'Screening',
        'v': pipeline['Screening']?.toString() ?? '0',
        'p': 0.75,
        'c': Colors.orange,
      },
      {
        'l': 'Interview',
        'v': pipeline['Interview']?.toString() ?? '0',
        'p': 0.35,
        'c': Colors.indigo,
      },
      {
        'l': 'Hired',
        'v': pipeline['Hired']?.toString() ?? '0',
        'p': 0.1,
        'c': Colors.green,
      },
    ];
  ...
  Widget _buildEfficiencyTab(BuildContext context, bool isDark) =>
      _buildPlaceholder('Recruiter Productivity', isDark);
  Widget _buildReportingTab(BuildContext context, bool isDark) =>
      _buildPlaceholder('Custom Reports', isDark);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Enterprise reporting engine loading...',
            style: GoogleFonts.inter(
              fontSize: Responsive.fontSize(12),
              color: Colors.grey,
            ),
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (val, meta) {
                if (trends.isEmpty || val.toInt() >= trends.length)
