            ...
            children: [
              Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) =>
                    Icon(Icons.bolt, color: AppColors.getPrimary(isDark)),
              ),
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'We can help with account questions, recruiter onboarding, candidate experience issues, AI interview workflow questions, subscription matters, and platform feedback.',
                style: GoogleFonts.inter(
                  fontSize: 14.5,
                  color: subtitleColor,
                  height: 1.5,
              ...
              _buildContactPoint(
                'Support',
                'Questions about access, profile issues, applications, or interview flow.\n\nMail ID : info.serphawk@gmail.com\nContact No : +91 97477 51235',
                cardColor,
                borderColor,
                textColor,
                subtitleColor,
              ...
              _buildContactPoint(
                'Business enquiries',
                'Recruiter onboarding, partnerships, or platform adoption discussions.',
                cardColor,
                borderColor,
                textColor,
                subtitleColor,
              ...
              _buildContactPoint(
                'Feedback',
                'Suggestions, bug reports, and ideas that can improve the hiring experience.',
                cardColor,
                borderColor,
                textColor,
                subtitleColor,
                ...
                child: Column(
                  children: [
                    ...
                    _buildTextField(
                      _messageController,
                      'Message',
                      'Share the details and we will review your message.',
                      isDark,
                      maxLines: 5,
                    ),
                    const SizedBox(height: 24),
